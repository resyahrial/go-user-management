...
type GetUserDetailUsecaseTestSuite struct {
	suite.Suite
...
func TestGetUserDetailUsecase(t *testing.T) {
	suite.Run(t, new(GetUserDetailUsecaseTestSuite))
}

func (s *GetUserDetailUsecaseTestSuite) SetupTest() {
...
func (s *GetUserDetailUsecaseTestSuite) TestGetUserDetail() {
